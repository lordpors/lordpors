#!/usr/bin/env python3
"""
Kotak masuk Agent 1 — laci sendiri, terpisah dari agen lain.

Dipakai saat Porscy bilang "cek kotak masuk". Pesan yang dia kirim dari
kantor-lordpors.vercel.app dengan awalan  /agen1  mendarat di sini dan
TIDAK terlihat oleh agen lain.

    python3 kotak1.py                  lihat pesan untuk Agent 1
    python3 kotak1.py --gambar         ikut simpan lampiran ke ./lampiran1/
    python3 kotak1.py --kosongkan      hapus pesan Agent 1 sesudah dibaca
    python3 kotak1.py --kosongkan --termasuk-lama
